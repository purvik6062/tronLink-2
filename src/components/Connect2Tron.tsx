...
import "./Connect2Tron.css";
import { TronLinkAdapter } from "@tronweb3/tronwallet-adapter-tronlink";

function Connect2Tron() {
  ...
  return (
    <div>
      <button className="cnct-btn" onClick={connectFun}>
        Connect Wallet
      </button>
...
//     <div>
//       {currentAccount ? (
//         <p style={{ color: "white" }}>Connected Wallet: {currentAccount}</p>
//       ) : (
...
//         setMessage(`Connected to TronLink with address: ${currentAddress}`);
//       } catch (error) {
//         toast.error("An error occurred while connecting to TronLink.");
//       }
//     } else {
//       toast.error("TronLink not detected or not ready.");
//     }
//   };

//   const openTronLink = async () => {
//     if (!window.tronWeb) {
...
//   return (
//     <div>
//       <button onClick={openTronLink}>Connect to TronLink</button>
//       <p>{message}</p>
//       <ToastContainer />
//     </div>
//   );
